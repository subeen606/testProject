...
<p class="pageCaption" align="left">회원 목록</p>
<table style="vertical-align: middle;">
<col width="2.5%"><col width="12.5%"><col width="20%">
 ...
 if(list==null || list.size()==0){
	 ...
	 for(MemberDto dto : list){
		 ...
		 <tr class="detail">
		 	...
		 	<td id="_3" align="center"><%=dto.getUserName() %></td>
		 	<td id="_4">
		 		<%
		 	...
		 	<td id="_5" align="center"><%=dto.getPhoneNumber() %></td>
		 </tr>
		 <%
		 }
	 }
...
<tr>
	<th colspan="6" style="border: none">
		...
		for(int i=1; i<pageNum+1; i++){
			%>
			<a style="text-decoration: none; color: black" href="/TAMINO/AdminCtrl?command=Member_list&page=<%=i-1%>"><%=i %></a>
			<%
		}
		%>
	</th>
