...
<a class="backA" href="/TAMINO/AdminCtrl?command=Adminvideo"><p id="back"> &#10094; &nbsp; 뒤로가기 </p></a>  <!-- list로 가기 -->
<p class="pageCaption" align="left">NEWS(VIDEO) 작성</p>
<form action="/TAMINO/AdminCtrl?command=writevideo" method="post" enctype="multipart/form-data">
...
<tr>
	<th>제목</th>
	<td>
		<input type="text" name="title" size="50px" id="title">		
	</td>
</tr>
